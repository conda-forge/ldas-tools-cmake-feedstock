...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/ldas-tools-cmake-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/ldas-tools-cmake-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add ldas-tools-cmake
# for installing globally
pixi global install ldas-tools-cmake
```
...
It is possible to list all of the versions of `ldas-tools-cmake` available on your platform:
...
```
pixi search ldas-tools-cmake --channel conda-forge
```
